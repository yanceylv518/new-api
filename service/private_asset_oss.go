...
func NewPrivateAssetOSSStorage() (*PrivateAssetOSSStorage, error) {
	settings, err := system_setting.NormalizeAndValidatePrivateAssetOSSSettings(system_setting.GetPrivateAssetOSSSettings())
	if err != nil {
