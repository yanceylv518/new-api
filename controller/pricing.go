...
func GetPricing(c *gin.Context) {
	...
	var group string
	var modelDiscountBPS map[string]int
	if exists {
	...
	if exists {
		for i := range pricing {
			if discountBPS := modelDiscountBPS[ratio_setting.FormatMatchingModelName(pricing[i].ModelName)]; discountBPS >= 1 && discountBPS < 10000 {
