...
export function UserModelPricingDialog(props: UserModelPricingDialogProps) {
  ...
  return (
    <Dialog
      ...
      contentClassName='flex max-h-[85vh] sm:max-w-3xl'
      contentHeight='auto'
      ...
      {!isLoading && !hasLoadError && (
        <Form {...form}>
          ...
          >
            ...
            <div className='grid shrink-0 grid-cols-[minmax(0,1fr)_9rem] gap-2 px-1 text-xs font-medium'>
              <span>{t('Model')}</span>
            ...
            {totalFilteredModels === 0 ? (
              ...
              <>
                    ...
                    <div className='divide-y'>
                      {paginatedRows.map(({ model, index }) => (
                        <div
                          ...
                          className='grid grid-cols-[minmax(0,1fr)_9rem] items-start gap-2'
                        >
                ...
                <div
                  ...
                  className='flex shrink-0 flex-col gap-2 px-1 text-xs sm:flex-row sm:items-center sm:justify-between'
                >
